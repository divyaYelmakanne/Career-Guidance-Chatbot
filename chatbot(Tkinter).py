...
You can type your symptoms one by one, and when finished, type done to get the prediction, description, and precautions.

Works offline (just needs Python and the required libraries).

⚠️ If you want to deploy this project on the web (like Streamlit Cloud), don’t use this Tkinter code. Instead, use the Streamlit version of the chatbot.
